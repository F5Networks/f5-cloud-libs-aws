 ...
 *                    is complete
 */
AwsAutoscaleProvider.prototype.tagMasterInstance = function tagMasterInstance(masterId, instances) {
    const deferred = q.defer();
    let clusterTagKey;
 ...
 * @param {Object} instances - Collection of instances within the cluster
