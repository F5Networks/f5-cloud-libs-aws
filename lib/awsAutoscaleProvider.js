...
try {
    ...
    KEYS = require('../../../../f5-cloud-libs').sharedConstants.KEYS;
}
catch (err) {
    AutoscaleProvider = require('f5-cloud-libs').autoscaleProvider;
    BigIp = require('f5-cloud-libs').bigIp;
...
function AwsAutoscaleProvider(options) {
    ...
    if (options.logger) {
        ...
        cloudUtil.setLoggerOptions(options.loggerOptions);
 ...
 * @returns {Promise} A promise which will be resolved when init is complete.
 */
AwsAutoscaleProvider.prototype.bigIpReady = function() {
        ...
        return bigIp.init(
            ...
            .then(function() {
                if (this.instancesToRevoke.length > 0) {
                    ...
                    return this.revokeLicenses(this.instancesToRevoke, {bigIp: bigIp});
                }
            }.bind(this));
    }
    else {
