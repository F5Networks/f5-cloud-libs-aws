...
function send_stat()
{
   ...
   f5-rest-node /config/cloud/aws/putMetricData.js --metricName $2 --namespace $VE_AUTO_SCALE_GROUP_NAME --timestamp $(date --iso-8601=seconds) --statisticValues $stat_result --region $EC2_REGION
   ...
   f5-rest-node /config/cloud/aws/putMetricData.js --metricName $2 --namespace $VE_AUTO_SCALE_GROUP_NAME --timestamp $(date --iso-8601=seconds) --statisticValues $stat_result --dimensions "instance-id=$inst_id" --region $EC2_REGION
...
function send_stat_delta()
{
   ...
   f5-rest-node /config/cloud/aws/putMetricData.js --metricName $3-per-sec --namespace $VE_AUTO_SCALE_GROUP_NAME --timestamp $(date --iso-8601=seconds) --statisticValues $stat_result_delta --region $EC2_REGION 
   ...
   f5-rest-node /config/cloud/aws/putMetricData.js --metricName $3-per-sec --namespace $VE_AUTO_SCALE_GROUP_NAME --timestamp $(date --iso-8601=seconds) --statisticValues $stat_result_delta --dimensions "instance-id=$inst_id" --region $EC2_REGION
...
function send_throughput()
{
   ...
   f5-rest-node /config/cloud/aws/putMetricData.js --metricName $2-per-sec --namespace $VE_AUTO_SCALE_GROUP_NAME --timestamp $(date --iso-8601=seconds) --statisticValues $1 --region $EC2_REGION 

   f5-rest-node /config/cloud/aws/putMetricData.js --metricName $2-per-sec --namespace $VE_AUTO_SCALE_GROUP_NAME --timestamp $(date --iso-8601=seconds) --statisticValues $1 --dimensions "instance-id=$inst_id" --region $EC2_REGION
